...
function Extension(){return <section className="container extension"><div><span className="eyebrow">TRUTHLENS EXTENSION</span><h2>Verify what you see, anywhere.</h2><p>See suspicious media while browsing? Verify it instantly with the ThelivLens browser extension.</p><button className="btn">Add to Browser <ArrowRight size={17}/></button></div><div className="extension-popup"><header><ShieldCheck size={18}/> <b>ThelivLens</b><span>•••</span></header><div className="popup-warning">⚠ <b>Potentially<br/>Manipulated</b></div><p>Confidence: <strong>86%</strong></p><hr/><small>Why?</small><ul><li>Synthetic artifacts</li><li>Missing metadata</li><li>Source uncertain</li></ul><button>View Full Analysis <ArrowRight size={15}/></button></div></section>}
